...
const LooholeSummary = Loadable({
  loader: () => import(/*webpackChunkName:'User'*/ "@/views/loophole/DatabaseSummary"),
  loading: Loading,
})
...
export default [
  ...
  { path: "/loophole/summary", component: LooholeSummary, roles: ["admin", "editor"] },
